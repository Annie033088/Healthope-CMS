                fill="#F24822"
              />
            </g>
            <defs>
    ...
    <div
      class="sidebarRow"
      v-if="
        permissionMap.EditLeaseAgreement || permissionMap.SelectLeaseAgreement
      "
    >
      <button class="btnSidebar" @click="redirect('/leaseAgreement')">
        <svg
          class="sidebarIcon"
          width="24"
          height="24"
    ...
    <div>
      <div class="sidebarRow" v-if="orderFlag">
        <button
          class="btnDropDownSidebar"
          @click="
            dropDownFlag.Order ? closeDropdown('Order') : openDropdown('Order')
          "
        >
          <svg
            class="sidebarIcon"
      ...
      <div
        class="btnSubContainer"
        :class="dropDownFlag.Order ? 'showDropdown' : 'hideDropdown'"
        @animationend="handleAnimationEnd('Order')"
        v-if="showElement.Order"
      >
        <BtnSubSideBar
    ...
    <div>
      <div class="sidebarRow" v-if="settingFlag">
        <button
          class="btnDropDownSidebar"
          @click="
            dropDownFlag.Setting
        ...
        >
          ...
          >
            <path
              d="M19.9 12.66C19.7397 12.4775 19.6513 12.2429 19.6513 12C19.6513 11.7571 19.7397 11.5225 19.9 11.34L21.18 9.90002C21.321 9.74269 21.4086 9.54472 21.4302 9.33452C21.4517 9.12433 21.4062 8.9127 21.3 8.73002L19.3 5.27002C19.1949 5.08754 19.0349 4.94289 18.8427 4.8567C18.6506 4.77051 18.4362 4.74718 18.23 4.79002L16.35 5.17002C16.1108 5.21945 15.8617 5.17961 15.6499 5.05802C15.438 4.93643 15.278 4.7415 15.2 4.51002L14.59 2.68002C14.5229 2.4814 14.3951 2.30888 14.2246 2.18686C14.0542 2.06484 13.8496 1.99948 13.64 2.00002H9.64C9.42193 1.98864 9.20613 2.04894 9.02556 2.17173C8.84499 2.29452 8.70958 2.47304 8.64 2.68002L8.08 4.51002C8.002 4.7415 7.84197 4.93643 7.63011 5.05802C7.41825 5.17961 7.16922 5.21945 6.93 5.17002L5 4.79002C4.80455 4.7624 4.6053 4.79324 4.42735 4.87866C4.24939 4.96407 4.1007 5.10025 4 5.27002L2 8.73002C1.89116 8.91067 1.84222 9.1211 1.86018 9.33124C1.87814 9.54138 1.96208 9.74046 2.1 9.90002L3.37 11.34C3.53032 11.5225 3.61873 11.7571 3.61873 12C3.61873 12.2429 3.53032 12.4775 3.37 12.66L2.1 14.1C1.96208 14.2596 1.87814 14.4587 1.86018 14.6688C1.84222 14.8789 1.89116 15.0894 2 15.27L4 18.73C4.1051 18.9125 4.26512 19.0571 4.45725 19.1433C4.64938 19.2295 4.86382 19.2529 5.07 19.21L6.95 18.83C7.18922 18.7806 7.43825 18.8204 7.65011 18.942C7.86197 19.0636 8.022 19.2585 8.1 19.49L8.71 21.32C8.77958 21.527 8.91499 21.7055 9.09556 21.8283C9.27613 21.9511 9.49193 22.0114 9.71 22H13.71C13.9196 22.0006 14.1242 21.9352 14.2946 21.8132C14.4651 21.6912 14.5929 21.5186 14.66 21.32L15.27 19.49C15.348 19.2585 15.508 19.0636 15.7199 18.942C15.9317 18.8204 16.1808 18.7806 16.42 18.83L18.3 19.21C18.5062 19.2529 18.7206 19.2295 18.9127 19.1433C19.1049 19.0571 19.2649 18.9125 19.37 18.73L21.37 15.27C21.4762 15.0873 21.5217 14.8757 21.5002 14.6655C21.4786 14.4553 21.391 14.2573 21.25 14.1L19.9 12.66ZM18.41 14L19.21 14.9L17.93 17.12L16.75 16.88C16.0298 16.7328 15.2806 16.8551 14.6446 17.2238C14.0086 17.5925 13.5301 18.1819 13.3 18.88L12.92 20H10.36L10 18.86C9.76985 18.1619 9.29138 17.5725 8.6554 17.2038C8.01943 16.8351 7.27022 16.7128 6.55 16.86L5.37 17.1L4.07 14.89L4.87 13.99C5.36195 13.44 5.63393 12.7279 5.63393 11.99C5.63393 11.2521 5.36195 10.54 4.87 9.99002L4.07 9.09002L5.35 6.89002L6.53 7.13002C7.25022 7.27724 7.99943 7.1549 8.6354 6.78622C9.27138 6.41753 9.74985 5.82818 9.98 5.13002L10.36 4.00002H12.92L13.3 5.14002C13.5301 5.83818 14.0086 6.42753 14.6446 6.79622C15.2806 7.1649 16.0298 7.28724 16.75 7.14002L17.93 6.90002L19.21 9.12002L18.41 10.02C17.9236 10.5688 17.655 11.2767 17.655 12.01C17.655 12.7433 17.9236 13.4513 18.41 14ZM11.64 8.00002C10.8489 8.00002 10.0755 8.23461 9.41772 8.67414C8.75992 9.11366 8.24723 9.73838 7.94448 10.4693C7.64173 11.2002 7.56252 12.0045 7.71686 12.7804C7.8712 13.5563 8.25216 14.269 8.81157 14.8284C9.37098 15.3879 10.0837 15.7688 10.8596 15.9232C11.6356 16.0775 12.4398 15.9983 13.1707 15.6955C13.9016 15.3928 14.5264 14.8801 14.9659 14.2223C15.4054 13.5645 15.64 12.7911 15.64 12C15.64 10.9392 15.2186 9.92174 14.4684 9.17159C13.7183 8.42144 12.7009 8.00002 11.64 8.00002ZM11.64 14C11.2444 14 10.8578 13.8827 10.5289 13.663C10.2 13.4432 9.94362 13.1308 9.79224 12.7654C9.64086 12.3999 9.60126 11.9978 9.67843 11.6098C9.7556 11.2219 9.94608 10.8655 10.2258 10.5858C10.5055 10.3061 10.8619 10.1156 11.2498 10.0384C11.6378 9.96128 12.0399 10.0009 12.4054 10.1523C12.7708 10.3036 13.0832 10.56 13.3029 10.8889C13.5227 11.2178 13.64 11.6045 13.64 12C13.64 12.5305 13.4293 13.0392 13.0542 13.4142C12.6791 13.7893 12.1704 14 11.64 14Z"
              fill="#757575"
            />
          </svg>
      ...
      <div
        class="btnSubContainer"
        :class="dropDownFlag.Setting ? 'showDropdown' : 'hideDropdown'"
        @animationend="handleAnimationEnd('Setting')"
        v-if="showElement.Setting"
      >
        <BtnSubSideBar
          v-if="permissionMap.EditOrder"
          text="發票字軌設定"
          @click="redirect('/setting/invoiceTrackNumber')"
        ></BtnSubSideBar>
      </div>
    </div>
    <div>
...
export default {
  ...
  computed: {
    ...
    orderFlag() {
      return (
        this.permissionMap.EditOrder ||
        this.permissionMap.SelectOrder ||
        this.permissionMap.AddOrder
      );
    },
    settingFlag() {
