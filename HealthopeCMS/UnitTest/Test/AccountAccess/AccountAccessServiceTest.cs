...
namespace UnitTest.Test.AccountAccess
{
    ...
    public class AccountAccessServiceTest
    {
        ...
        public void 登入SA_成功_回傳管理者資料()
        {
            ...
            sessionServiceMock.Setup(s => s.SaveCookie("AdminIdentityCookie", admin.Identity));
            sessionServiceMock.Setup(s => s.SaveCookie("AdminPermissionCookie", adminPermissionUtility.GetPermissions(identity)));
